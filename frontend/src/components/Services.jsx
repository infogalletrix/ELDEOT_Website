    ...
    <section className="bg-[#FAF7F2] pt-24 pb-12 px-4 md:px-6 lg:px-12">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-[#D97736] font-sans font-medium tracking-wide uppercase text-sm mb-4">
            What We Do
          </p>
          <h2 className="text-5xl md:text-6xl font-bold font-serif text-[#1A1A1A] mb-6">
            Our Services
          </h2>
          <p className="text-gray-500 font-sans text-lg md:text-xl max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              {/* Image Container Wrapper (no overflow-hidden here, so icon can overflow) */}
              <div className="relative w-full aspect-[4/3] mb-12 rounded-[1.5rem] shadow-[0_8px_30px_rgba(0,0,0,0.05)] group-hover:shadow-[0_25px_50px_rgba(217,119,54,0.18)] group-hover:-translate-y-2 group-hover:scale-[1.02] transition-all duration-500 ease-out z-10">
                {/* Image Mask (has overflow-hidden) */}
                ...
                {/* Icon Block (placed outside the mask, so it overflows correctly) */}
