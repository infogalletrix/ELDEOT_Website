...
const CTA = () => {
  return (
    <section className="relative py-32 flex items-center justify-center min-h-[500px]">
      ...
      >
        {/* White overlay to partially fade out the image */}
        <div className="absolute inset-0 bg-white/40"></div>
      </div>

      <div className="relative z-10 text-center px-4 md:px-6 max-w-3xl mx-auto flex flex-col items-center">
        <h2 className="text-5xl md:text-[56px] font-bold font-serif text-[#1A1A1A] mb-6">
          Ready to Transform Your Space?
        </h2>
        <p className="text-white text-lg md:text-xl font-sans mb-10 max-w-2xl drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] font-medium">
